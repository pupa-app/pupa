...
/// Shared header for a MiniApp's pages (Home / Agents / Memories / History) and
...
struct MiniAppPageHeader: View {
    /// The page name shown in the eyebrow, e.g. "Home", "Memories".
    let page: String
    /// The subject's name on the title line (the MiniApp or "Orchestrator").
    let name: String
    let icon: String
    let color: Color
